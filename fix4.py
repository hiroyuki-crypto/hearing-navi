...
old = 'function onSpeech(txt){if(!cur||!N[cur])return;var n=N[cur],o=ovlp(txt,n.s);if(o>0.3){spk="staff";custTxt="";clrCd()}else if(txt.length>3){if(spk==="staff"){spk="customer";stopMic();liveTxt="";custTxt="";setTimeout(startMic,300)}else{spk="customer";custTxt=txt;rstCd()}}updBar()}'
